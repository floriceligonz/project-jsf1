...
/**
 * autor:Floriceli
 * Clase que permie controlar el funcionamiento con la pantalla login
 */
@ManagedBean(name="loginCon")
public class LoginController {
	...
	public void ingresar() {
		...
		if(usuario.equals("flor")&& password.equals("1234")){
			...
			FacesContext.getCurrentInstance().addMessage("formLogin:txtUsuario", new FacesMessage(FacesMessage.SEVERITY_ERROR,"Usuario o contraseña incorrecta", ""));
